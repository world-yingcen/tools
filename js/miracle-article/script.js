...
const App = {
    config: {
        articleClassPrefix: 'miracle-article',
        ctaConfig: {
            defaultTitle: '立即預約品牌顧問諮詢',
            defaultDescription: '專業的內容佈局到設計策略，一起打造真正有感的品牌體驗網站',
            buttonText: '快速專人諮詢',
            buttonHref: '/contact',
            bgImageUrl: 'https://www.webtech.com.tw/asset/common/images/page-foot-bg.webp',
            bgImageAlt: '立即諮詢服務'
        }
    },
